...
<div class="right_col" role="main">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Edit Treatment <small> </small></h2>
        ...
        <div class="x_content">
          ...
          <form id="demo-form" data-parsley-validate action="<?php echo base_url('main/edittreatment')?>" method="post">
            <div class="col-md-offset-1 col-sm-10 col-xs-10">
              <div class="form-group col-md-12 col-sm-12 col-xs-12" >
                <label for="custname">Jenis Treatment :</label>
                <input type="text" id="kd_treatment" name="kd_treatment" class="form-control" hidden value="<?php echo $data[0]->KD_TREATMENT ?>"/>
                <input type="text" id="jenis_treatment" name="jenis_treatment" class="form-control" value="<?php echo $data[0]->JENIS_TREATMENT ?>" required />
              </div>
