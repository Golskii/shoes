    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <form id="demo-form" data-parsley-validate action="<?php echo base_url('main/additem')?>" method="post">
          	<div class="col-md-offset-1 col-sm-10 col-xs-10">
          		<div class="form-group col-md-12 col-sm-12 col-xs-12" >
                <label for="nama">Jenis Item :</label>
                <input  type="text" id="jenis_item" name="jenis_item" class="form-control" required />
              </div>
          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tbody>
                  <?php if(count(array($dat_item))): $no=1;?>
                    <?php foreach($dat_item as $item): ?>
                  <tr>
                    <td><?php echo $no++; ?></td>
                    <td>
                      <a> <?php echo $item->JENIS_ITEM; ?> </a>
                    </td>
                    <td>
                      <a href="<?=base_url('main/')?>formedititem/<?php echo $item->KD_ITEM?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Update </a>
                      <a href="<?=base_url('main/')?>hapusitem/<?php echo $item->KD_ITEM?>" class="btn btn-danger btn-xs" onclick="return confirm('Ingin hapus data?')"><i class="fa fa-trash"></i> Delete </a>
                    </td>
                  </tr>
                    <?php endforeach; ?>
                  <?php else: ?>
